...
interface InCollectionDrawerProps {
  entry: Reference;
}

function InCollectionDrawer({ entry }: InCollectionDrawerProps) {
              ...
              <tr>
                ...
                <td>
                  <Show when={entry.title} fallback={""}>
                    <ChunksComp
                      chunks={entry.title!}
                      citeKey={`InCollectionDrawer-${key}`}
                    />
                  </Show>
                </td>
              </tr>
...
export default InCollectionDrawer;
