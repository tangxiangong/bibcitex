...
interface MiscDrawerProps {
  entry: Reference;
}

function MiscDrawer({ entry }: MiscDrawerProps) {
        ...
        <div className="collapse-content">
          <table className="table table-sm">
            <tbody>
              ...
              <tr>
                <td className="text-right">Archive</td>
                <td>arXiv</td>
              </tr>
              <tr>
                <td className="text-right">ePrint</td>
                <td>{entry.eprint || ""}</td>
              </tr>
              <tr>
                <td className="text-right">Primary Class</td>
                <td>{entry.arxiv_primary_class || ""}</td>
              </tr>
              <tr>
